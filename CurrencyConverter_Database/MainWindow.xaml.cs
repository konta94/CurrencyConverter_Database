...
namespace CurrencyConverter_Database
{
    public partial class MainWindow : Window
    {
        ...
        private void BindCurrency()
        {
            ...
            sqlCommand = new SqlCommand("select Id, CurrencyName from Currency_Master", dbConnection);
                ...
                {   //Edit time and set that record Id in CurrencyId variable.
                    ...
                    else
                    {
                        if (MessageBox.Show("Are you sure you want to save ?", "Information", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
                        {
                            ...
                            sqlCommand = new SqlCommand("INSERT INTO Currency_Master(Amount, CurrencyName) VALUES(@Amount, @CurrencyName)", dbConnection);
                            sqlCommand.CommandType = CommandType.Text;
                            sqlCommand.Parameters.AddWithValue("@Amount", txtAmount.Text);
                            sqlCommand.Parameters.AddWithValue("@CurrencyName", txtCurrencyName.Text);
                            sqlCommand.ExecuteNonQuery();
        ...
        public void GetData()
        {
            ...
            sqlCommand = new SqlCommand("SELECT * FROM Currency_Master", dbConnection);
                        ...
                        if (grd.SelectedCells.Count > 0)
                        {
                            ...
                            if (grd.SelectedCells[0].Column.DisplayIndex == 1)
                            {
                                ...
                                if (MessageBox.Show("Are you sure you want to delete ?", "Information", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
                                {
                                    ...
                                    sqlCommand = new SqlCommand("DELETE FROM Currency_Master WHERE Id = @Id", dbConnection);
                                    sqlCommand.CommandType = CommandType.Text;
        ...
        private void cmbFromCurrency_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                ...
                if (cmbFromCurrency.SelectedValue != null && int.Parse(cmbFromCurrency.SelectedValue.ToString()) != 0 && cmbFromCurrency.SelectedIndex != 0)
                {
                    ...
                    sqlCommand = new SqlCommand("SELECT Amount FROM Currency_Master WHERE Id = @CurrencyFromId", dbConnection);
                    sqlCommand.CommandType = CommandType.Text;
        ...
        private void cmbToCurrency_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                ...
                if (cmbToCurrency.SelectedValue != null && int.Parse(cmbToCurrency.SelectedValue.ToString()) != 0 && cmbToCurrency.SelectedIndex != 0)
                {
                    ...
                    sqlCommand = new SqlCommand("SELECT Amount FROM Currency_Master WHERE Id = @CurrencyToId", dbConnection);
                    sqlCommand.CommandType = CommandType.Text;
